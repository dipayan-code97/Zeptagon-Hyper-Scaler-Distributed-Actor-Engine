...
func (monitorRef *monitor) Receive(c *actor.Context) {
	...
	case actor.DeadLetterEvent:
		monitorRef.deadletters++
	case query:
		c.Respond(query{
			crashes:     monitorRef.crashes,
			starts:      monitorRef.starts,
			stops:       monitorRef.stops,
			deadletters: monitorRef.deadletters,
		})
	}
